...
namespace ColorDetector.Activities
{
    ...
    public class ColorFromImage : CodeActivity
    {
        ...
        [Category("Input")]
        [RequiredArgument]
        [Description("Input the image as typeof Image class in System.Drawing")]
        [DisplayName("Image")]
        public InArgument<Image> ImageVal { get; set; }
        [Category("Input")]
        [RequiredArgument]
        ...
        protected override void Execute(CodeActivityContext context)
        {
            ...
            Image in_Image = ImageVal.Get(context);
